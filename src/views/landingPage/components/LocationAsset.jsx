...
function LocationAsset() {
    return (
        <div className="sm:w-2/5" >
            ...
            <h4 className="text-black70 mr-4 font-bold"> <span className="bg-black text-white rounded font-bold px-2 py-1 mr-2" >123</span> Restaurants </h4>
            <h4 className="text-black70  font-bold"> <span className="bg-black text-white rounded font-bold px-2 py-1 mr-2" >2342</span> Dishes </h4>
            </div>
        </div>
    )
}
